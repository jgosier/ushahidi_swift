...
/** #########  Apala required changes ##########
		settings should come for api the 7 lines below	*/	
...
/** #########  Apala required changes ########## DB Call below. ::factory('page')*/
		...
		/** #########  Apala required changes ##########
		settings should come for api the 3 lines below	*/	
...
/** #########  Apala required changes ##########
The API should control the caching of news feeds lines below to 157	*/	
		// Cache the Feed
...
/** #########  Apala required changes ##########
The API should control the addition of news feeds the function add($feedtype = 'rss2') below 	*/
	/**
	...
	public function add($feedtype = 'rss2') 
	{
		...
		//	exit(0);
			...
			if ($post->validate())
			{
				...
				/** #########  Apala required changes ########## DB Call below. new Feed_Model();*/
				$feed = new Feed_Model();
...
/** #########  Apala required changes ##########
The API should control the categories of news feeds the function _get_categories($selected_categories) below 	*/
