 ...
 * @license    http://www.gnu.org/copyleft/lesser.html GNU Lesser General (LGPL)
 */
...
?>
			...
			<!-- right column -->
							...
							<ul class="category-filters">			
								...
								<?php
									foreach ($categories as $category => $category_info)
									{
										...
										echo '<li><a '.$setactive.' href="'.url::base().'main/index/category/'.$category.'/page/1/" id="cat_'. $category .'"  title="Filter feeds by '.$category_title.' category"  ><div class="swatch" style="background-color:#'.$category_color.'"></div><div class="category-title">'.$category_title.'</div></a></li>';
										// Get Children
					...
					<input type="image" src="<?php echo url::base() ;?>media/img/submit_btn.png" name="veracitysubmit" id="veracitysubmit" value="Submit" title="Filter feeds by veracity."/>
